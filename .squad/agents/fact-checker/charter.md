...
- **Casting:** Built-in identity. Always "Fact Checker" (exempt from universe casting).
...
Standardized post-init Squad workflow/process updates across repositories using bash, pwsh, and C#.
